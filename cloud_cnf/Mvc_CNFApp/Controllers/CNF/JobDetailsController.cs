    ...
    public class JobDetailsController : AppController
    {
        ...
        public JsonResult JobNoChanged_getJobinfo(Int64 changedtxt)
        {
            ...
            else
            {
                ...
                decimal sbankpay = 0, laborcharge = 0,sshipcharge=0,transcharge=0,hmisccharge=0,recptcharge=0,othercharge=0,demurcharge=0,docpcost=0,epvalue=0,itcpcust=0,itcfinvv=0,itcpemp=0;
